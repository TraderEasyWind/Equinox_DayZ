...
class A6_KSGEmpty extends WeaponStableState
{
	...
	override int GetCurrentStateID () { return A6_KSGStableStateID.Fireout; }
...
class A6_KSGFireout extends WeaponStableState
{
	override void OnEntry (WeaponEventBase e) { if (LogManager.IsWeaponLogEnable()) { wpnPrint("[wpnfsm] " + Object.GetDebugName(m_weapon) + " { Fireout F"); } super.OnEntry(e); }
	override void OnExit (WeaponEventBase e) { super.OnExit(e); if (LogManager.IsWeaponLogEnable()) { wpnPrint("[wpnfsm] " + Object.GetDebugName(m_weapon) + " } Fireout F"); } }
	override int GetCurrentStateID () { return A6_KSGStableStateID.Fireout; }
...
class A6_KSGLoaded extends WeaponStableState
{
	...
	override int GetCurrentStateID () { return A6_KSGStableStateID.Loaded; }
	override bool HasBullet () { return true; }
	override bool HasMagazine () { return false; }
	override bool IsJammed () { return false; }
	override bool IsRepairEnabled () { return true; }
...
class A6_KSGJammed extends WeaponStateJammed
{
	...
	override int GetCurrentStateID () { return A6_KSGStableStateID.Jammed; }
	override bool HasBullet () { return true; }
	override bool HasMagazine () { return false; }
...
class A6_KSG_Base : Rifle_Base
{
	...
	override void InitStateMachine ()
	{
		...
		// basic weapon states
		E = new PumpShotgunEmpty(this, NULL, A6_KSGAnimState.DEFAULT);
		F = new PumpShotgunFireout(this, NULL, A6_KSGAnimState.DEFAULT);
		L = new PumpShotgunLoaded(this, NULL, A6_KSGAnimState.DEFAULT);
		J = new PumpShotgunJammed(this, NULL, A6_KSGAnimState.DEFAULT);
//--------------------------------------------------------------------------------------

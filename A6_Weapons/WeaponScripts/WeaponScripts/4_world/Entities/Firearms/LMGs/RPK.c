class A6_RPK_Base : RifleBoltFree_Base {
	void A6_RPK_Base(){	
		ShowPistolGrip(this);
	}
    ...
    override void OnDebugSpawn() {
        ...
        inventory.CreateInInventory( "A6_RPK_Buttstock" );
        inventory.CreateInInventory( "A6_RPK_Muzzle" );
        inventory.CreateInInventory( "A6_AK_Handguard_RPK" );
        inventory.CreateInInventory( "A6_AK_Bakelite_PistolGrip" );
        SpawnAttachedMagazine("A6_Mag_RPK_75Rnd");
    }
};

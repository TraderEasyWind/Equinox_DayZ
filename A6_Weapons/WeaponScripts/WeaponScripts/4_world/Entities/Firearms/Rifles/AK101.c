class A6_AK101_Base : RifleBoltFree_Base {
	void A6_AK101_Base() {	
		ShowPistolGrip(this);
	}
...
class A6_AK101 : A6_AK101_Base {
    override void OnDebugSpawn() {
        ...
        inventory.CreateInInventory( "A6_AK_TubeStock_Adapter" );
        inventory.CreateInInventory( "A6_DD_Buttstock" );
        inventory.CreateInInventory( "A6_AK203_Muzzle" );
        inventory.CreateInInventory( "A6_AK_Handguard_Zentico_Long_Black" );
        inventory.CreateInInventory( "A6_B25U_RK2_Grip" );
        inventory.CreateInInventory( "A6_AK_MOE_PistolGrip" );
        inventory.CreateInInventory( "A6_AK_Dustcover_Optic_Mount" );
        #ifdef A6_OpticScripts      
        inventory.CreateInInventory( "A6_EoTechOptic" );    
        inventory.CreateInInventory( "Battery9V" );
        #endif
        SpawnAttachedMagazine("A6_Mag_AK101_30Rnd");
    }
};
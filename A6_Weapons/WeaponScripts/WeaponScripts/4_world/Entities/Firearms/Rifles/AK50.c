class A6_AK50_Base : RifleBoltFree_Base {
    void A6_AK50_Base() {   
        ShowPistolGrip(this);
        ShowFrontsight(this);
    }
	...
	override void EEItemAttached(EntityAI item, string slot_name) {	
        ...
        if ( A6_AK_Handguard_Tactical_Polymer_Base.Cast(item) ) {
    		SetAnimationPhase("translation", 0.7);
    	}
	...
	override void EEItemDetached(EntityAI item, string slot_name) {	
        ...
        if ( A6_AK_Handguard_MOE.Cast(item) || A6_AK_Handguard_Tactical_Polymer_Base.Cast(item) ) {
...
class A6_AK50 : A6_AK50_Base {
    override void OnDebugSpawn() {
        ...
        inventory.CreateInInventory( "A6_Zhukov_Buttstock" );
        inventory.CreateInInventory( "A6_HXQD_Suppressor" );
        inventory.CreateInInventory( "A6_AK_Handguard_Zentico_Long_Black" );
        inventory.CreateInInventory( "A6_Troy_Grip" );
        inventory.CreateInInventory( "A6_AK_12_PistolGrip" );
        inventory.CreateInInventory( "A6_AK_Dustcover_Optic_Mount" );
        #ifdef A6_OpticScripts      
        inventory.CreateInInventory( "A6_SigSauerTango6T_Optic" );    
        #endif

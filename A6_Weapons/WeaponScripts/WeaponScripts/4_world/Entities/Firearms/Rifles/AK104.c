class A6_AK104_Base : RifleBoltFree_Base {
	void A6_AK104_Base() {	
		ShowPistolGrip(this);
	}
...
class A6_AK104 : A6_AK104_Base 
{
    override void OnDebugSpawn()
    {
        GameInventory inventory = GetInventory();
        inventory.CreateInInventory( "A6_PT1_Buttstock" );
        inventory.CreateInInventory( "A6_AK_PSB1_Suppressor" );
        inventory.CreateInInventory( "A6_AK_Handguard_Zentico_Long_Black" );
        inventory.CreateInInventory( "A6_RK0_Grip" );
        inventory.CreateInInventory( "A6_AK_Zenitco_RK3_PistolGrip" );
        ...
        SpawnAttachedMagazine("A6_Mag_AKM_PMAG_30Rnd");
    }
};
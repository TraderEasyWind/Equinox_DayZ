class DeCraftA6MilitaryLocker extends DeCraftA6KitBase {
	override void Init() {
		...
		//ingredient 1  
		InsertIngredient(0, "A6_MilitaryLocker_Green_Kit");
		InsertIngredient(0, "A6_MilitaryLocker_Tan_Kit");
		InsertIngredient(0, "A6_MilitaryLocker_Black_Kit");

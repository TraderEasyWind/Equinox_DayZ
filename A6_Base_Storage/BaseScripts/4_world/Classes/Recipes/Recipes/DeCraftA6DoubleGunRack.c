class DeCraftA6DoubleGunRack extends DeCraftA6KitBase {
	override void Init() {
		...
		//ingredient 1  
		InsertIngredient(0, "A6_DoubleGunRack_Kit");
		InsertIngredient(0, "A6_DoubleGunRack_Tan_Kit");
		InsertIngredient(0, "A6_DoubleGunRack_Black_Kit");

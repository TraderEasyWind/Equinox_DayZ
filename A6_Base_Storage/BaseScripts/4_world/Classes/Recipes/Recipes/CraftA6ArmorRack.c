class CraftA6ArmorRack extends CraftA6KitBase {
	override void Init() {
		m_Name = GetA6BaseStorageConfig().ArmorStandCraftText;
		m_IsInstaRecipe = false;
		m_AnimationLength = GetA6BaseStorageConfig().CraftKitToolTime;
		int recipeMakeCost = GetA6BaseStorageConfig().ArmorStandRecipeOneQty;
		int recipeResourceCost = GetA6BaseStorageConfig().ArmorStandRecipeTwoQty;
		m_recipeitemone = GetA6BaseStorageConfig().ArmorStandRecipeOne;
		m_recipeitemtwo = GetA6BaseStorageConfig().ArmorStandRecipeTwo;
		//conditions

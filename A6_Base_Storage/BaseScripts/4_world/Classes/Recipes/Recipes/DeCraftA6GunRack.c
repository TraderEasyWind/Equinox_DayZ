class DeCraftA6GunRack extends DeCraftA6KitBase {
	override void Init() {
		m_Name = GetA6BaseStorageConfig().DeCraftKitText;
		m_IsInstaRecipe = false;
		m_AnimationLength = GetA6BaseStorageConfig().DeCraftKitToolTime;
		int recipeMakeCost = GetA6BaseStorageConfig().SingleGunrackRecipeOneQty;
		int recipeResourceCost = GetA6BaseStorageConfig().SingleGunrackRecipeTwoQty;
		m_recipeitemone = GetA6BaseStorageConfig().SingleGunrackRecipeOne;
		m_recipeitemtwo = GetA6BaseStorageConfig().SingleGunrackRecipeTwo;
		...
		//ingredient 1  
		InsertIngredient(0, "A6_SingleGunRack_Kit");
		InsertIngredient(0, "A6_SingleGunRack_Tan_Kit");
		InsertIngredient(0, "A6_SingleGunRack_Black_Kit");

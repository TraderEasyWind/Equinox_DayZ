class MountTopSight extends RecipeBase {	
	override void Init() {
		...
		//ingredient 1
		InsertIngredient(0,"A6_SigSauerBravo4Optic");
		InsertIngredient(0,"A6_LeupoldOptic");
		...
		//ingredient 2
		InsertIngredient(1,"A6_SigSauerRomeoXLOptic");
		...
		InsertIngredient(1,"A6_SigSauerRomeo0_Optic");

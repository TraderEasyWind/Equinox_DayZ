modded class BaseBuilding
{
	override float GetTimeToDecay()
	{
		switch (GetMaterialLevel()) {
			case MaterialLevel.FRAME: return 336.0 * 60.0 * 60.0; //2 hours
			case MaterialLevel.WOOD: return 336.0 * 60.0 * 60.0; //12 hours
			case MaterialLevel.METAL: return 336.0 * 60.0 * 60.0; //18 hours
			case MaterialLevel.CONCRETE: return 336.0 * 60.0 * 60.0; //24 hours
		}

		return 336.0 * 60.0 * 60.0; //24 hours
	}
}

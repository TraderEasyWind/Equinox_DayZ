modded class CraftTruck01DoubleWheel extends RecipeBase
{
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"MassiveMod_Med_TruckWheel");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"MassiveMod_Med_TruckWheel");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("MassiveMod_Med_TruckWheel_Double");//add results here
...
modded class DeCraftTruck01DoubleWheel extends RecipeBase
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"MassiveMod_Med_TruckWheel_Double");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("MassiveMod_Med_TruckWheel");//add results here

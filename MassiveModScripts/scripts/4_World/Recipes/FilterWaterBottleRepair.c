class MassiveMod_RepairFilterBottle extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Replenish Charcoal Filter";
    ...
    {
        ItemBase Meow = ingredients[0];    // 0 for the first item  - 1 for the second one
        Meow.AddHealth("", "",100);
    }

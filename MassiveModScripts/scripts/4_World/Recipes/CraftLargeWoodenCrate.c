class CraftLargeWoodenBox extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Craft Large Wooden Box";
		...
		m_IngredientAddQuantity[1] = -90;// 0 = do nothing
		m_IngredientDestroy[1] = false;// false = do nothing
		m_IngredientUseSoftSkills[1] = false;// set 'true' to allow modification of the values by softskills on this ingredient
		//----------------------------------------------------------------------------------------------------------------------
		
		//result1
		AddResult("MassiveMod_LargeWoodenCrate");//add results here

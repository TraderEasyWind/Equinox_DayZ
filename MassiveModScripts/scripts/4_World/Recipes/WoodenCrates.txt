class StackCrates extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Stack Crates X2 (Remove Items Inside Before Doing This)";
		...
		//result1
		AddResult("MassiveMod_WoodenCrateX2");//add results here
...
class StackCrates2 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Stack Crates X4(Remove Items Inside Before Doing This)";
		m_IsInstaRecipe = true;//should this recipe be performed instantly without animation
		m_AnimationLength = 0.1;//animation length in relative time units
		m_Specialty = -0.02;// value > 0 for roughness, value < 0 for precision
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"MassiveMod_WoodenCrateX2");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"MassiveMod_WoodenCrateX2");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("MassiveMod_WoodenCrateX4");//add results here
...
class StackCrates3 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Stack Crates X8(Remove Items Inside Before Doing This)";
		m_IsInstaRecipe = true;//should this recipe be performed instantly without animation
		m_AnimationLength = 0.1;//animation length in relative time units
		m_Specialty = -0.02;// value > 0 for roughness, value < 0 for precision
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"MassiveMod_WoodenCrateX4");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"MassiveMod_WoodenCrateX4");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("MassiveMod_WoodenCrateX8");//add results here
...
class DeStackCrates3 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Split Stacked Crates(Remove Items Inside Before Doing This)";
		m_IsInstaRecipe = true;//should this recipe be performed instantly without animation
		m_AnimationLength = 0.1;//animation length in relative time units
		m_Specialty = -0.02;// value > 0 for roughness, value < 0 for precision
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"MassiveMod_WoodenCrateX8");//you can insert multiple ingredients this way
...
class DeStackCrates2 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Split Stacked Crates(Remove Items Inside Before Doing This)";
...
class DeStackCrates1 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Split Stacked Crates(Remove Items Inside Before Doing This)";

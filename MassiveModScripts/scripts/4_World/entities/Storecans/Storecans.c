class MM_Store_SpaghettiCan: SpaghettiCan
{
	override void Open()
	{
		ReplaceEdibleWithNew("MM_Store_SpaghettiCan_Opened");
	}
...
class MM_Store_BakedBeansCan: BakedBeansCan
{
	override void Open()
	{
		ReplaceEdibleWithNew("MM_Store_BakedBeansCan_Opened");
	}
...
class MM_Store_PeachesCan: PeachesCan
{
	override void Open()
	{
		ReplaceEdibleWithNew("MM_Store_PeachesCan_Opened");
	}
...
{	
	override void Init()
	{
		...
		InsertIngredientEx(0,"MM_Store_SpaghettiCan", "openBeanCan");//you can insert multiple ingredients this way
		InsertIngredientEx(0,"MM_Store_BakedBeansCan", "openBeanCan");//you can insert multiple ingredients this way
		InsertIngredientEx(0,"MM_Store_PeachesCan", "openBeanCan");//you can insert multiple ingredients this way

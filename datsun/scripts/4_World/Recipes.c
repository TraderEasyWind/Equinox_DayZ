class CraftUnfinishedDatsunCab extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Craft Unfinished Datsun Cab";
		...
		m_MinQuantityIngredient[1] = 18;//-1 = disable check
		...
		m_IngredientAddQuantity[1] = -18;// 0 = do nothing
		m_IngredientDestroy[1] = false;// false = do nothing
		m_IngredientUseSoftSkills[1] = true;// set 'true' to allow modification of the values by softskills on this ingredient
		//----------------------------------------------------------------------------------------------------------------------
		
		//result1
		AddResult("UnfDatsunCab");//add results here
...
class CraftfinishedDatsunCab extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Craft finished Datsun Cab";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 1;//animation length in relative time units
		m_Specialty = -0.01;// value > 0 for roughness, value < 0 for precision
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"UnfDatsunCab");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("DatsunCab");//add results here
